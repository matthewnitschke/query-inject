...
})({"10adc56ba7f36db466958262998f43e1":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "009928804561730db84397f723a7db87";
...
},{}],"3c9da24cede6c46fa9d8170fd531c833":[function(require,module,exports) {
"use strict";

var _inject = _interopRequireDefault(require("./inject.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

chrome.storage.sync.get(['globalEnabled', 'queryParams', 'urlMatchers'], ({
  globalEnabled,
  queryParams,
  urlMatchers
}) => {
  if (!history.pushState) return;
  let injectedUrl = (0, _inject.default)({
    globalEnabled,
    queryParams,
    urlMatchers,
...
},{"./inject.js":"ef4a4fdbbb8094b6ccecdafdd97f5e98"}],"ef4a4fdbbb8094b6ccecdafdd97f5e98":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = getInjectedUrl;
...
function injectParams(url, queryParams) {
  ...
  queryParams.filter(param => param.enabled).forEach(({
    key,
    value
...
function doesUrlMatch(url, matchUrls) {
  const regexUrl = `(${matchUrls.join(')|(')})`.replace(/\//g, '\\/') // escape '/' charachters
...
},{}]},{},["10adc56ba7f36db466958262998f43e1","3c9da24cede6c46fa9d8170fd531c833"], null)
